...
def set_ood_loader(args, out_dataset):
    ...
    if out_dataset == 'SVHN':
        ...
        testsetout = torchvision.datasets.ImageFolder(root="/root/autodl-tmp/tlt/dataset/SUN",
        ...
        testsetout = torchvision.datasets.ImageFolder(root="/root/autodl-tmp/tlt/dataset/Places",
                                    #transform=transforms.Compose([transforms.Resize(32), transforms.CenterCrop(32), transforms.ToTensor(),normalize]))
                                    transform=test_transform)

    elif out_dataset == 'iNaturalist':
        testsetout = torchvision.datasets.ImageFolder(root="/root/autodl-tmp/tlt/dataset/iNaturalist",
                                    #transform=transforms.Compose([transforms.Resize(32), transforms.CenterCrop(32), transforms.ToTensor(),normalize]))
                                    transform=test_transform)
    elif out_dataset == 'Texture':
        testsetout = torchvision.datasets.ImageFolder(root="/root/autodl-tmp/tlt/dataset/dtd/images",
                                    transform=test_transform)
    else:

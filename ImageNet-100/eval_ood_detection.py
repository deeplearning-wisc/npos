...
def process_args():
    ...
    parser.add_argument('-b', '--batch-size', default=2048, type=int, help='mini-batch size')
    ...
    '/root/autodl-tmp/tlt/CLIP/5/ImageNet-100_dense_baseline_dense_epoch_26.pt', help='Method name.')

...
class ImageEncoder(nn.Module):
    def __init__(self, num_classes=100, layers=8,  type='ViT-L/14', device='cuda', T=0.1):
        ...
        self.fc = nn.Linear(640, num_classes).to(device)
    ...
    def forward(self, input, fc=False):
        ...
        feature = self.visual(input.half()).float()

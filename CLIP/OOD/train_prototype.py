...
#net.load_state_dict({k.replace('module.', ''): v for k, v in torch.load('/nobackup-slow/taoleitian/model/vos/ImageNet-100/MCM/prototype/NPOS_1/ImageNet-100_dense_baseline_dense_epoch_19.pt').items()}, strict=False)
CLIP_ft
...
def train(epoch, ood_list):
    ...
    for idx, (data, target) in enumerate(train_loader):
        ...
        # forward
        x, output, energy_score_for_fg = net(data, target=target)

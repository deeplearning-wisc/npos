...
from CLIP.CLIP_data import CLIP_model
...
if args.dataset == 'cifar10':
    ...
    train_data = ImageSubfolder(root_dir + 'val', transform=test_transform, class_to_idx=class_to_idx)
    test_data = ImageSubfolder(root_dir + 'train', transform=test_transform, class_to_idx=class_to_idx)
...
net = CLIP_model(num_classes=num_classes, layers=num_layers)

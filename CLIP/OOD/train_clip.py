...
parser.add_argument('--learning_rate', '-lr', type=float, default=0.0000001, help='The initial learning rate.')
parser.add_argument('--batch_size', '-b', type=int, default=320, help='Batch size.')
parser.add_argument('--test_bs', type=int, default=200)
parser.add_argument('--momentum', type=float, default=0.9, help='Momentum.')
parser.add_argument('--decay', '-d', type=float, default=0.1, help='Weight decay (L2 penalty).')
# WRN Architecture
...
if args.dataset == 'cifar10':
    ...
    train_data = clip_feature(path='/afs/cs.wisc.edu/u/t/a/taoleitian/private/code/dataset/ImageNet100/train/')
    ...
    for data, target in train_loader:
        ...
        if sum_temp == num_classes * args.sample_number and epoch < args.start_epoch:
            ...
            if len(ood_samples) != 0:
                ...
                predictions_ood = net(ood_samples, fc=True)

...
parser.add_argument('--load', '-l', type=str, default='/nobackup-slow/taoleitian/model/vos/ImageNet-100/epoch/10/0.01/600/6000/5/', help='Checkpoint path to resume / test.')
...
txt_path = os.path.join(args.load, args.method_name+ '.txt')
if args.save ==True:
    output_content = open(txt_path, "a")
...
if 'cifar10_' in args.method_name:
    ...
    test_data = clip_feature(path='/afs/cs.wisc.edu/u/t/a/taoleitian/private/code/dataset/ImageNet100/val/')
    num_classes = 100
...
net = clipnet(num_classes=num_classes)
start_epoch = 0
...
# /////////////// iNaturalist ///////////////
ood_data = clip_feature("/nobackup-slow/dataset/ImageNet_OOD_dataset_feature/iNaturalist/")
...
ood_data = clip_feature("/nobackup-slow/dataset/ImageNet_OOD_dataset_feature/Places/")
...
# /////////////// SUN ///////////////
ood_data = clip_feature("/nobackup-slow/dataset/ImageNet_OOD_dataset_feature/SUN/")
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,
                                         num_workers=2, pin_memory=True)
print('\n\nSUN Detection')
get_and_print_results(ood_loader, encode_feature=False)
...
# /////////////// Textures ///////////////
ood_data = clip_feature("/nobackup-slow/dataset/ImageNet_OOD_dataset_feature/Textures/")
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,

...
parser.add_argument('--dataset', '-m', type=str, default='ImageNet-100', help='Method name.')
# Loading details
...
# Restore model
if args.load != '':
    net.load_state_dict({k.replace('module.', ''): v for k, v in torch.load(args.load).items()},strict=False)
    print('Model restored!')

else:
    assert False, "could not resume model "
